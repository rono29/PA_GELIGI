        ...
        <div class="page-content-wrapper">
            ...
            <div class="page-content">
                ...
                <div class="page-breadcrumb d-none d-sm-flex align-items-center mb-3">
                    <div class="breadcrumb-title pe-3">Edit Data Artikel</div>
                </div>
                ...
                <div class="card shadow-sm border-0 rounded-4">
                    <div class="card-body p-4">
                        ...
                        <h4 class="fw-bold mb-4">Edit Data Artikel</h4>
                        ...
                        <form action="<?= base_url('admin/artikel/update/' . $artikel->id_artikel) ?>" method="post" enctype="multipart/form-data">
                            ...
                            <div class="form-group mt-2">
                                ...
                                <?php if ($artikel->gambar): ?>
                                    <p>Gambar Saat Ini:</p>
                                    <img src="<?= base_url('admin/artikel/gambar/' . $artikel->id_artikel) ?>" alt="Gambar" width="200">
                                <?php endif; ?>
