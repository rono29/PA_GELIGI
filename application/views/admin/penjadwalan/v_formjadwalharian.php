        ...
        <div class="page-content-wrapper">
            ...
            <div class="page-content">
                ...
                <div class="page-breadcrumb d-none d-sm-flex align-items-center mb-3">
                    <div class="breadcrumb-title pe-3">Kelola Jadwal Harian</div>
                    <div class="ps-3">
                        <nav aria-label="breadcrumb">
                            <ol class="breadcrumb mb-0 p-0 align-items-center">
                                <li class="breadcrumb-item active" aria-current="page">Tambah Jadwal Harian</li>
                            </ol>
                        </nav>
                    </div>
                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <label class="form-label">Waktu Praktik Dimulai</label>
                        <input class="form-control mb-3" type="time" aria-label="default input example">

                        <label class="form-label">Estimasi Waktu Pelayanan</label>
                        <input class="form-control mb-3" type="time" aria-label="default input example">

                        <label class="form-label">Tanggal Praktik</label>
                        <input class="form-control mb-3" type="date" aria-label="default input example">

                        <label class="form-label">Waktu Praktik Berakhir</label>
                        <input class="form-control mb-3" type="time" aria-label="default input example">

                        <label class="form-label">Jumlah Slot Pasien</label>
                        <input class="form-control mb-3" type="number" aria-label="default input example">
